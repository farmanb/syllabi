...
},
{
  ...
  "body": " Course Information   Course Description  Fundamental set concepts, groups, rings, integral domains, fields, polynomials.    Course Prerequisites  A grade of C or better in MATH 3073 (Previously MATH 307) or MATH 3113 (Previously MATH 311).    Student Learning Outcomes  The primary goal of this course is to gain familiarity with basic algebraic structures (groups, rings, and fields) and how they interact with one another (actions, homomorphisms, etc.). An equally important goal of this course is to improve students’ ability to read and write mathematical proofs.    Course Topics  This course can be divided into two parts. In the first, we cover the definitions and examples of groups, subgroups, quotient groups, homomorphisms, and important theorems about the structure of certain groups. In the second, we encounter basic definitions and examples of rings, subrings, ideals, quotients of rings, domains, fields, homomorphisms, and other topics as time permits.    Instructional Methods  This course is offered as a face-to-face course. Learning will be facilitated through traditional lecture, group work\/activities, homework, and in-class assessments.   "
},
{
  "id": "evaluation",
  "level": "1",
  ...
  "number": "3",
  "title": "Evaluation",
  "body": " Evaluation     Exams  There will be two in-class exams and a cumulative final exam. The exams are scheduled as follows:     Exam  Date    Exam 1  Friday, October 3, 2025    Exam 2  Friday, October 24, 2025    Final Exam  Wednesday, November 12, 2025         The instructor reserves the right to modify the schedule of in class exams.    The final exam date and time are scheduled in advanced. Failure to appear at the final exam will result in a grade of zero for the exam.        Homework  Homework will be assigned regularly. The problems are chosen to highlight the core concepts from the material. Mastery of these homework sets serves as a good indicator for performance on assessments. As such, you should ensure that you fully understand the material on these homework sets; that is, upon completion of the homework set, you should be capable of completing similar problems without the aid of the text, a computer, or any other tools not available during an exam.    Weights  Grades will be calculated using the weights below.   Evaluation Criteria    Grade Category  Weight    Homework  30%    Exam 1  20%    Exam 1  20%    Final Exam  30%       Grading Scale  Letter grades will be assigned based on the scale below.   Grading Scale    Average  Letter Grade     A     B     C     D     F      "
},
{
  "id": "exams-4",
  "level": "2",
