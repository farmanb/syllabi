...
},
{
  ...
  "number": "3.1",
  "title": "Grading Scale",
  "body": " Grading Scale    Letter Grade  Number of Standards Mastered    A  17 18    B  15 17    C  13 14    D  11 12    F  0-10    "
},
{
  "id": "standards",
  "level": "1",
  ...
  "number": "4",
  "title": "Standards",
  "body": " Standards        Systems of Equations (SE)   Systems of Equations 1   I can..     identify whether or not a matrix is in Reduced Row Echelon Form,    use Gaussian Elimination to put a matrix into Reduced Row Echelon Form,    use the Reduced Row Echelon Form of an augmented matrix to describe the solution space to a system of linear equations using appropriate notation.      Homework: Section 1.2.5 , Exercises 1 - 2.     Systems of Equations 2   I can..     use Pivot Positions to determine whether a linear system is consistent,  determine whether the solution to a consistent linear system is unique.     Homework: Section 1.4.4 , Exercises 1 - 3.      Vectors and Matrices (VM)   Vectors and Matrices 1   I can..     add vectors,    scale vectors by a real number,    determine whether a vector can be expressed as a linear combination of a set of given vectors.      Homework: Section 2.1.4 Exercises 1, 2, 3, 5.     Vectors and Matrices 2   I can..     add matrices,    scale matrices by a real number,    perform matrix-vector multiplication,    perform matrix-matrix multiplication,    translate a system of equations into a matrix equation of the form .      Homework: Section 2.2.6 Exercises 1 - 6.     Vectors and Matrices 3   I can..     determine whether a vector is in the span of a given set of vectors,    describe the span of a set of vectors as a set,    use the span to determine whether a linear system is consistent.      Homework: Section 2.3.4 Exercises 1 - 5, 10.     Vectors and Matrices 4   I can..     I can determine whether a given set of vectors is linearly independent.      Homework: Section 2.4.5 Exercises 1, 2, 5.     Vectors and Matrices 5   I can..     define a matrix transformation,    find the domain and range of a matrix transformation,    compose matrix transformations,    determine whether a given function is a matrix transformation.      Homework: Section 2.5.4 Exercises 1 - 4.      Invertibility and Bases (IB)   Invertibility and Bases 1   I can..     use Gaussian Elimination to determine whether a matrix is invertible,    find the inverse of an invertible matrix.      Homework: Section 3.1.5 Exercises 1 - 4.     Invertibility and Bases 2   I can..     find a basis for a space,    translate between the coordinate systems for different bases.      Homework: Section 3.2.5 Exercises 1 - 4.     Invertibility and Bases 3   I can..     compute the determinant of a given matrix,    use the determinant to determine whether a matrix is invertible.      Homework: Section 3.4.5 Exercises 1, 3, 4, 6.     Invertibility and Bases 4   I can..     find a basis for the null space of a given matrix,    find a basis for the column space of a given matrix,    determine whether a given set satisfies the definition of a vector space.      Homework: Section 3.5.5 Exercises 1, 2, 5.      Eigentheory (ET)   Eigentheory 1   I can..     determine whether a vector is an eigenvector of a given matrix,    find the eigenvalue associated to an eigenvector.      Homework: Section 4.1.4 Exercises 1, 2, 5, 6.     Eigentheory 2   I can..     use the characteristic polynomial to find the eigenvalues of a given matrix,    find the algebraic and geometric multiplicities of eigenvalues,    find a basis for the eigenspace associated to an eigenvalue.      Homework: Section 4.2.6 Exercises 1, 2, 5.     Eigentheory 3   I can..     determine whether a given matrix is diagonalizable,    diagonalize a diagonalizable matrix.      Homework: Section 4.3.5 Exercises 1, 2, 7.      Orthogonality (OR)   Orthogonality 1   I can..     compute the dot product of two vectors,    use the dot product to find the angle between two vectors,    determine whether two vectors are orthogonal.      Homework: Section 6.1.4 Exercises 1 - 4.     Orthogonality 2   I can..     compute the transpose of a matrix,    use the transpose to find a basis for the orthogonal complement of a given vector space.      Homework: Section 6.2.4 Exercises 1 - 3.     Orthogonality 3   I can..     I can perform Orthogonal Decomposition.      Homework: Section 6.3.4 Exercises 1 - 6.     Orthogonality 4   I can..     use Gram-Schmidt Orthogonalization to find an orthogonal basis for a given vector space,    find an orthonormal basis from an orthogonal basis for a given vector space.      Homework: Section 6.4.4 Exercises 1 - 5.      "
},
{
  "id": "policies",
  "level": "1",
